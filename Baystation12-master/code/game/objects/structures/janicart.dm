/obj/structure/janitorialcart
	...
	desc = "This is the alpha and omega of sanitation. It can carry sprays, trashbags, light replacers, mops, water and signs. Handy!"
...
/obj/structure/janitorialcart/attack_hand(mob/user)
	...
	user << browse(dat, "window=Janitorial_Cart") //Used to be different on /tg/ due to the new UI, if anyone wonders. - Raz
	onclose(user, "Janitorial_Cart")
	return
