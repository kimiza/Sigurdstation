...
/proc/get_all_accesses()
	return list(access_security, access_sec_doors, access_brig, access_armory, access_forensics_lockers, access_court,
	            ...
	            access_keycard_auth, access_tcomsat, access_gateway, access_xenoarch, access_console)
...
/proc/get_region_accesses(var/code)
	switch(code)
		...
		if(4) //engineering and maintenance
			return list(access_construction, access_maint_tunnels, access_engine, access_engine_equip, access_external_airlocks, access_tech_storage, access_atmospherics, access_ce, access_console)
		if(5) //command
