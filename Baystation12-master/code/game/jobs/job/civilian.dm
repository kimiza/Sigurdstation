...
/datum/job/lawyer
	...
	selection_color = "#dddddd"
	access = list(access_lawyer, access_court, access_sec_doors, access_maint_tunnels, access_heads, access_console)
	minimal_access = list(access_lawyer, access_court, access_sec_doors, access_heads, access_console)
